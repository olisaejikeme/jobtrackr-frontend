        ...
        <div className="h-screen flex overflow-hidden bg-[#F8FAFC] dark:bg-slate-950 transition-colors duration-300">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 bg-white lg:bg-[#F8FAFC] dark:bg-slate-950 transition-colors duration-300">
                <div className="flex items-center gap-2 mb-10">
                    <div className="w-8 h-8 bg-[#0F172A] dark:bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold shadow-lg">J</div>
                    <span className="text-xl font-bold text-[#0F172A] dark:text-white tracking-tight">JobTrackr</span>
                </div>

                <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[32px] p-10 shadow-sm transition-all duration-300">
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 outline-none focus:bg-white dark:focus:bg-slate-900 focus:border-blue-500 transition-all font-medium text-slate-700 dark:text-white"
                        />
                    </div>
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <span
                                ...
                                className="text-[11px] font-bold text-slate-500 dark:text-slate-400 cursor-pointer hover:text-[#0F172A] dark:hover:text-blue-400 transition-colors"
                            >
                                Forgot password?
                            </span>
                        </div>
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={loading}
                        className="w-full bg-[#0F172A] dark:bg-blue-600 text-white py-4 rounded-2xl font-bold hover:shadow-xl transition-all active:scale-[0.98] disabled:opacity-60 flex items-center justify-center gap-2"
                    >
                    ...
                    <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-8">
                        ...
                        <span onClick={() => navigate("/register")} className="font-bold text-[#0F172A] dark:text-blue-400 cursor-pointer hover:border-b-2 border-[#0F172A]">Join JobTrackr</span>
                    </p>
                </div>
